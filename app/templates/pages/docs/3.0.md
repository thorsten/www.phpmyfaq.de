...
description: This guide contains detailed documentation for those using phpMyFAQ 3.0, whether they be administrators or end-users.
canonical: docs/3.0
layout: docs.hbs
---
...
PHP 7.1+ is needed in order to access this data. phpMyFAQ also offers a multi-language Content Management
...
templates, PDF-support, a backup-system, a dynamic sitemap, related FAQs, tagging, RSS feeds, built-in spam protection systems, 
OpenLDAP and Microsoft Active Directory support, and an easy to use installation script. You can run phpMyFAQ on almost
every web hosting provider or in the cloud in a Docker container.
...
© 2001-2019 by Thorsten Rinne and phpMyFAQ Team under the [Mozilla Public License 2.0](http://www.mozilla.org/MPL/2.0/). 
All rights reserved.
...
*   **[PHP](http://www.php.net)**
    *   from version 7.1+ (recommended: latest PHP 7.x)
    *   memory_limit = 64M
    *   cURL support
    *   GD support
    *   XMLWriter support
...
*   **Database server**
    ...
    *   [PostgreSQL](http://www.postgresql.org) 9.x (recommended: latest 10.x)
    ...
    *   [Percona Server](http://www.percona.com) 5.8.x (experimental)
...
In case you're running PHP before 7.1 you cannot use phpMyFAQ.
...
***2.2.1. <a id="2.2.1"></a>Classic Web Hosting***
...
***2.2.2. <a id="2.2.2"></a>Cloud Hosting via Docker***
...
be created with UTF-8 character set before running the installation script. You can leave the prefix-field empty. If 
...
**3.3. <a id="3.3"></a>Upgrading phpMyFAQ 2.10.0-alpha**
...
Your current v 2.x templates are **not** compatible with phpMyFAQ 3.0 because we changed the complete CSS framework to 
Bootstrap v4.
...
**5.3. <a id="5.3"></a>Section Administration**
...
**5.4. <a id="5.4"></a>Category Administration**
...
**5.5. <a id="5.5"></a>FAQ Administration**
...
**5.6. <a id="5.6"></a>Comment Administration**
...
**5.8. <a id="5.8"></a>News Administration**
...
**5.9. <a id="5.9"></a>Attachment Administration**
...
**5.13. <a id="5.13"></a>Configuration**
...
**5.14. <a id="5.14"></a>Multisite Configuration**
...
**6. <a id="6"></a>Customizing phpMyFAQ 3.x**
